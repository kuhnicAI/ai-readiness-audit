...
We found areas where your business could recover around ${Math.round(waste.totalWaste / 1000)}k per year. The full breakdown is on your results page, and you can download the PDF from there.
...
<body style="margin:0;padding:0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:1.6;color:#333;">
  <div style="max-width:560px;margin:0 auto;padding:32px 20px;">
    ...
    <p>We found areas where your business could recover around ${Math.round(waste.totalWaste / 1000)}k per year. The full breakdown is on your results page, and you can download the PDF from there.</p>
