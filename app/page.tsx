...
const TESTIMONIALS = [
  {
    quote: 'The system runs quietly in the background and removes almost all manual work from client intake. Our team focuses on legal work, not admin.',
    name: 'Daniel Yaniv, Esq.',
    designation: 'Founder, Yaniv & Associates',
    src: '/testimonials/daniel-yaniv.jpg',
  },
  {
    quote: 'Before this, we were pulling credit reports, searching SAP, googling companies one by one. Now the system hands us a report in minutes and says here\'s who to trust.',
    name: 'Kristina Brahmstaedt',
    designation: 'AI Support Team Lead, AroundTown',
    src: '/testimonials/kristina-brahmstaedt.jpg',
  },
  {
    quote: 'Clients now complete the Statement of Net Worth correctly the first time. Our team no longer spends days fixing forms.',
    name: 'Mary Katherine Brown',
    designation: 'Founder, Brooklyn Family Divorce Lawyer',
    src: '/testimonials/mary-katherine-brown.jpg',
  },
  {
    quote: 'Thanks for turning around so quickly, it\'s impressive work.',
    name: 'Henry Lewis',
    designation: 'Partner, Anesi Advisors',
    src: '/testimonials/henry-lewis.jpg',
  },
  {
    quote: 'We\'ve always been known for big ideas. Now we finally have the backend systems to match that energy.',
    name: 'Pedro Coronado',
    designation: 'Creative Director, DMentes',
    src: '/testimonials/pedro-coronado.jpg',
  },
  {
    ...
    designation: 'Chief of Growth, NeuronUP',
    src: '/testimonials/fernando-bozalongo.jpg',
  },
]
